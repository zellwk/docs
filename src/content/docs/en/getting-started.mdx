...
:::caution[UNMAINTAINED V3.6 DOCS]
**This is a snapshot of the Astro Docs just prior to the release of v4.0**

This branch is unmaintained, and some content here is outdated and unsupported.

However, if you do need to consult documentation for a project that must continue to run on Astro v3.x, you can view the documentation appropriate for that version here.
:::
